...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "赵永斐"
  # spec.authors            = { "赵永斐" => "zhaoyongfei2008@163.com" }
  # spec.social_media_url   = "https://twitter.com/赵永斐"
  ...
  spec.source       = { :git => "https://github.com/woLongDaFei/MFAnimatesLib.git", :tag => "0.0.1" }
